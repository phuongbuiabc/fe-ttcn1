    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-2xl bg-white rounded-[3rem] shadow-2xl overflow-hidden shadow-emerald-900/5"
        >
          <div className="h-32 bg-gradient-to-r from-[#006c49] to-[#00a67d]">
            <button 
              onClick={onClose} 
          ...
          <div className="px-10 pb-12">
            <div className="relative -mt-16 mb-6">
              <div className="w-32 h-32 bg-white rounded-[2.5rem] p-2 shadow-xl">
                <div className="w-full h-full bg-[#e2f7f1] rounded-[2.5rem] flex items-center justify-center text-4xl font-black text-[#00a67d]">
            ...
            <div className="flex justify-between items-start mb-10">
              <div>
                <h2 className="text-3xl font-black text-slate-800 tracking-tight">{staff.full_name}</h2>
                <p className="text-sm font-bold text-[#00a67d] uppercase tracking-widest mt-1">{staff.position}</p>
              </div>
              <div className="text-right">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Mã nhân viên</p>
                <p className="text-xl font-black text-slate-900 leading-none mt-2">#{staff.employee_id}</p>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-x-12 gap-y-8 py-8 border-y border-slate-50 mb-8">
